					...
					<meta charset="utf-8">
						<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
							...
							<link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
													...
													<div >
														<div class="layui-form-item layui-form-text" id="hnameParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<input type="text"  style="display:inline;width:400px" value="${data.hname}" placeholder="请输入姓名" id="hname" class="layui-input">
														...
														<div class="layui-form-item layui-form-text" id="hageParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<input type="text"  style="display:inline;width:400px" value="${data.hage}" placeholder="请输入年龄(请输入数字)" id="hage" class="layui-input">
																<p style="color:gray"></p>
															</div>
														</div>
														<div class="layui-form-item layui-form-text" id="hzpParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<div class="imgUpload" tip="请输入照片"  red-tip=""  upload-num="1" init-val="${data.hzp}" upload-type="1" id="hzp"></div>
																<p style="color:gray"></p>
															</div>
														</div>
														...
														<div class="layui-form-item layui-form-text" id="hcelParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<input type="text"  style="display:inline;width:400px" value="${data.hcel}" placeholder="请输入联系电话" id="hcel" class="layui-input">
																<p style="color:gray"></p>
															</div>
														</div>
														<div class="layui-form-item layui-form-text" id="helpIntroParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<textarea  placeholder="请输入具体情况"  id="helpIntro"  rows="15" cols="100">${data.helpIntro}</textarea>
																<p style="color:gray"></p>
															</div>
														</div>
														<div class="layui-form-item layui-form-text" id="amountParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<input type="text"  style="display:inline;width:400px" value="${data.amount}" placeholder="请输入需要金额(请输入数字)" id="amount" class="layui-input">
																<p style="color:gray"></p>
															</div>
														</div>
								...
								<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9167"></script>
								<script type="text/javascript">
									$(function(){
									...
									$.ajax({
									type: 'post',
									url: '${pageContext.request.contextPath}/admin/help_msg/update_submit',
									data:{
									"id":'${data.id}',
									"hname":hname,
									"hage":hage,
