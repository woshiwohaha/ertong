...
var uri='${uri}';
					...
					<meta charset="utf-8">
						<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
												...
												<div >
													<div class="layui-form-item layui-form-text" id="loginNameParentContent">
														...
														<div class="layui-input-block" style="width:720px">
															<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入登录名" id="loginName" class="layui-input">
													...
													<div class="layui-form-item layui-form-text" id="passwordParentContent">
														...
														<div class="layui-input-block" style="width:720px">
															<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入密码" id="password" class="layui-input">
															<p style="color:gray"></p>
														</div>
													</div>
													<div class="layui-form-item layui-form-text" id="realNameParentContent">
														...
														<div class="layui-input-block" style="width:720px">
															<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入昵称" id="realName" class="layui-input">
															<p style="color:gray"></p>
														</div>
													</div>
													<div class="layui-form-item layui-form-text" id="celPhoneParentContent">
														...
														<div class="layui-input-block" style="width:720px">
															<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入联系电话" id="celPhone" class="layui-input">
															<p style="color:gray"></p>
														</div>
													</div>
													<div class="layui-form-item layui-form-text" id="addressParentContent">
														...
														<div class="layui-input-block" style="width:720px">
															<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入地址" id="address" class="layui-input">
															<p style="color:gray"></p>
														</div>
													</div>
							...
							<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=7408"></script>
							<script type="text/javascript">
								$(function(){
								})
								function submitData(){
								...
								$.ajax({
								type: 'post',
								url: '${pageContext.request.contextPath}/admin/user_msg/add_submit',
								data:{
								"loginName":loginName,
								"password":password,
								"realName":realName,
