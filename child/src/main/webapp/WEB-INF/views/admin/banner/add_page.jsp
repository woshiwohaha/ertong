					...
					<meta charset="utf-8">
						<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
							...
							<link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
													...
													<div >
														<div class="layui-form-item layui-form-text" id="bimgParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<div class="imgUpload" tip="请输入轮播图"  red-tip=""  upload-num="1" init-val="" upload-type="1" id="bimg"></div>
								...
								<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2453"></script>
								<script type="text/javascript">
									$(function(){
									...
									$.ajax({
									type: 'post',
									url: '${pageContext.request.contextPath}/admin/banner/add_submit',
									data:{
									"bimg":bimg,
									"helpId":helpId
									},
