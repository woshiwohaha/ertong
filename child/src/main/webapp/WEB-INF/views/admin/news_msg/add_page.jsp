					...
					<meta charset="utf-8">
						<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
							...
							<link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
													...
													<div >
														<div class="layui-form-item layui-form-text" id="newsNameParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入标题" id="newsName" class="layui-input">
														...
														<div class="layui-form-item layui-form-text" id="noticeImgParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<div class="imgUpload" tip="请输入图片"  red-tip=""  upload-num="1" init-val="" upload-type="1" id="noticeImg"></div>
																<p style="color:gray"></p>
															</div>
														</div>
								...
								<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=7613"></script>
								<script type="text/javascript">
									$(function(){
									...
									for(var i=0;i<wangList.length;i++){
										...
										$.ajax({
										type: 'post',
										url: '${pageContext.request.contextPath}/admin/news_msg/add_submit',
										data:{
										"newsName":newsName,
										"noticeImg":noticeImg,
