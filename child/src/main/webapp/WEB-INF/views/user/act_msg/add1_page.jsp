					...
					<meta charset="utf-8">
						<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
							...
							<link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
													...
													<div >
														<div class="layui-form-item layui-form-text" id="actNameParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入活动名" id="actName" class="layui-input">
														...
														<div class="layui-form-item layui-form-text" id="actImgParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<div class="imgUpload" tip="请输入图片"  red-tip=""  upload-num="1" init-val="" upload-type="1" id="actImg"></div>
																<p style="color:gray"></p>
															</div>
														</div>
														<div class="layui-form-item layui-form-text" id="actTimeParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入活动时间" id="actTime" class="layui-input">
																<p style="color:gray"></p>
															</div>
														</div>
														<div class="layui-form-item layui-form-text" id="addressParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入活动地点" id="address" class="layui-input">
																<p style="color:gray"></p>
															</div>
														</div>
														<div class="layui-form-item layui-form-text" id="contactMsgParentContent">
															...
															<div class="layui-input-block" style="width:720px">
																<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入联系方式" id="contactMsg" class="layui-input">
																<p style="color:gray"></p>
															</div>
														</div>
								...
								<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5547"></script>
								<script type="text/javascript">
									$(function(){
									...
									async:false,
									type: 'post',
									url: '${pageContext.request.contextPath}/user/act_msg/queryDataDetail',
									data:{
									"id":'${data.id}'
									},
									...
									for(var i=0;i<wangList.length;i++){
										...
										$.ajax({
										type: 'post',
										url: '${pageContext.request.contextPath}/user/act_msg/add1_submit',
										data:{
										"actName":actName,
										"actImg":actImg,
										"actTime":actTime,
										...
										alert(result.msg);
										window.location.href="${pageContext.request.contextPath}/user/act_msg";
										}
										}
										});
										}
