					...
					<meta charset="utf-8">
						<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
							...
							<link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
								...
								<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0244"></script>
								<script type="text/javascript">
									$(function(){
									...
									for(var i=0;i<wangList.length;i++){
										...
										$.ajax({
										type: 'post',
										url: '${pageContext.request.contextPath}/user/act_msg/update1_submit',
										data:{
										"id":'${data.id}',
										"actName":actName,
										"actImg":actImg,
